    ...
    (let ((system (str:trim (uiop:getenv "SYSTEM")))
      ...
      (tmpdir:with-tmpdir (dir)
        (uiop:with-current-directory (dir)
          ...
          (uiop:run-program (format nil "oras pull ghcr.io/ocicl/~A:~A" system v1) :output *standard-output*)
          ...
          (uiop:run-program (format nil "oras pull ghcr.io/ocicl/~A:~A" system v2) :output *standard-output*)
          (let ((file (car (uiop:directory-files dir))))
